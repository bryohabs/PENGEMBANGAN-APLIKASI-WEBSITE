...
// silakan taruh code kalian di bawah
if ($BB == 0 && $TB == 0) {
   $kilogram = "Tinggi badan dan berat badan tidak boleh kosong";
}
...
if (empty($BB == 0 && $TB == 0)) {
    $measure = $TB / 100; 
    $hasiltb = $BB / ($measure*$measure);
    if ($hasiltb <= 18.4) {
        $status = "Underweight"; 
    } elseif ($hasiltb >= 18.5 && $hasiltb <= 24.9) {
        $status = "Normal";
    } elseif ($hasiltb >= 25.0 && $hasiltb <=39.9) {
        $status = "Overweight";
    } elseif ($hasiltb >= 40) {
        $status = "Obese";
    }
        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- silakan taruh code kalian di bawah -->
                    <?php
                    echo "Hasil BMI     : ", $hasiltb;
                    echo "Hasil status  : ", $measure;
                    ?>
